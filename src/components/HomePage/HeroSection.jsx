...
const HeroSection = () => {
  ...
  const [activeImage, setActiveImage] = useState("/images/girl1.jpg");
  ...
  const hotelImages = [
    ...
    },
    {
      ...
      alt: "Hotel lobby",
      main: "/images/hero2.jpg",
    },
    {
      src: "/images/hero3.jpg",
      alt: "Hotel exterior",
      main: "/images/hero3.jpg",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-16 items-center">
          ...
          <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
            ...
            <p className="text-base sm:text-lg text-gray-700 leading-relaxed max-w-lg mx-auto lg:mx-0 text-center lg:text-left">
              Luxury hotel booking refers the process of reserving
              accommodations in high-end hotels that offer exceptional quality,
              comfort, and services. These establishments are often
              characterized by premium facilities.
            </p>

            {/* CTA Button */}
            <div className="flex justify-center lg:justify-start">
              <a href="#explore">
                <button className="inline-flex cursor-pointer items-center px-6 sm:px-8 py-3 sm:py-4 bg-white border-2 border-gray-300 text-gray-900 font-semibold text-sm sm:text-base rounded-lg hover:bg-[#C8A882] hover:border-gray-400 transition-all duration-200 group">
                  Explore Now
              ...
              <div className="flex space-x-3 sm:space-x-4">
                {hotelImages.map((image, index) => (
                  ...
                  >
                    ...
                    {/* Active indicator */}
                    {currentIndex === index && (
                      <div className="absolute inset-0 bg-opacity-20 flex items-center justify-center"></div>
                    )}
                  </div>
                ))}
              </div>
              ...
              <div className="absolute bottom-3 sm:bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-1.5 sm:space-x-2">
                {hotelImages.map((_, index) => (
                  <button
                    ...
                    onClick={() =>
                      handleThumbnailClick(hotelImages[index].main, index)
                    }
                  />
                ))}
              </div>
