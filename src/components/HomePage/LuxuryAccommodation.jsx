...
const LuxuryAccommodation = () => {
  ...
  return (
    <section
      id="explore"
      className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 py-12 sm:py-16 lg:py-20"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <h2
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-tight text-white max-w-4xl mx-auto px-4"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-2 relative group">
            ...
            >
              ...
              >
                <h3
                  className="text-2xl sm:text-3xl lg:text-4xl font-light text-white text-center px-4"
                  style={{ fontFamily: "Butler, Georgia, serif" }}
                >
          ...
          <div className="relative group">
            ...
            >
              ...
              >
                <h3
                  className="text-2xl sm:text-2xl lg:text-3xl font-light text-white text-center px-4"
                  style={{ fontFamily: "Butler, Georgia, serif" }}
                >
          ...
          <div className="lg:grid lg:grid-rows-2 lg:gap-4 lg:gap-6">
            ...
            <div className="relative group mb-4 sm:mb-6 lg:mb-0">
              ...
              >
                ...
                >
                  <h3
                    className="text-2xl lg:text-2xl font-light text-white text-center px-2"
                    style={{ fontFamily: "Butler, Georgia, serif" }}
                  >
